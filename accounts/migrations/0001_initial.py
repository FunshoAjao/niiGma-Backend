    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('prefer_not_to_say', 'Prefer not to say'), ('others', 'Others')], max_length=50)),
                ...
                ('wellness_status', models.CharField(blank=True, max_length=100, null=True)),
